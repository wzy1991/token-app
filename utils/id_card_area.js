...
export default function getAreaByIdCard(idCard) {
		 ...
		 var birthDay = ''
		 if(idCard.length === 15) {
		     age = new Date().getFullYear() - parseInt('19' + idCard.substring(6, 8));
		     sexNo = idCard.slice(-1)
		     birthDay = '19' + idCard.substring(6, 12)
		 } else {
		     age = new Date().getFullYear() - parseInt(idCard.substring(6, 10));
		     sexNo = idCard.slice(-2,-1)
		 ...
		 var resultObj = {}
		 resultObj = {
		     area: (provinceName ? provinceName : '') + (cityName ? cityName : '') + (countyName ? countyName : ''),
		     age: (age? age: ''),
		     sex: sexNo,
		     birthDate: birthDay,
		 }
